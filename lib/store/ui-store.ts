...
type SettingsSection = 'color' | 'font' | 'password'
...
interface UIStore {
  ...
  activeSettingSection: SettingsSection
...
export const useUIStore = create<UIStore>()(
  persist(
    (set) => ({
      ...
      activeSettingSection: 'color',
      colorTheme: 'light',
      fontTheme: 'sans',
      openSettings: () => set({ isSettingsOpen: true }),
      closeSettings: () => set({ isSettingsOpen: false }),
      setActiveSection: (section) => set({ activeSettingSection: section }),
      setColorTheme: (theme) => set({ colorTheme: theme }),
      setFontTheme: (theme) => set({ fontTheme: theme }),
    }),
    {
      name: 'tonote-ui-storage',
      partialize: (state) => ({
